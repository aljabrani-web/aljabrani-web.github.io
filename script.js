...
const animateElements = document.querySelectorAll('.skill-card, .portfolio-item, .about-text, .contact-info, .contact-form');
...
💻 تم تطوير هذا الموقع باستخدام HTML, CSS & JavaScript
📧 للتواصل: your.email@example.com
🌟 شكراً لزيارتك!
`);
